/**
 * Seed script: Crea 24 documentos en ecosistema_materiales_pfh2
 *
 * Uso:
 *   FIREBASE_SERVICE_ACCOUNT_JSON='...' node scripts/seed-pfh2-materiales.js
 *
 * O si la variable ya está en .env:
 *   node -r dotenv/config scripts/seed-pfh2-materiales.js
 */
...
async function seed() {
  const colRef = db.collection('ecosistema_materiales_pfh2');
  ...
  console.log(`Creando ${documentos.length} documentos en ecosistema_materiales_pfh2...`);
