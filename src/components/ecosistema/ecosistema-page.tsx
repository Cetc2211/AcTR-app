...
const ECOSISTEMAS = [
  ...
  },
  {
    ...
    titulo: 'Lo que somos mientras decidimos',
    subtitulo: 'Racionalismo, empirismo y crítica de la razón',
    descripcion: 'Dieciséis módulos que recorren la tradición racionalista y empirista hasta Kant. Novela narrativa, cuadernillo interactivo y guía docente.',
    caps: '16 módulos · 3 materiales por módulo',
    color: '#2a1a50',
    colorClaro: '#f0eaf8',
    acento: '#8b6cc7',
  ...
  },
  {
    ...
    descripcion: 'Dieciséis módulos sobre ética aplicada, estética y filosofía política. Novela narrativa, cuadernillo interactivo y guía docente.',
    caps: '16 módulos · 3 materiales por módulo',
    color: '#3a2060',
    colorClaro: '#f2eaf8',
    acento: '#b07de0',
