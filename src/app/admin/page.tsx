        ...
        <div className="flex flex-col gap-6">
            ...
            <Card className="border-orange-200 bg-orange-50/50 dark:bg-orange-950/20 dark:border-orange-800">
                <CardHeader>
                    ...
                    <CardDescription>
                        Sincroniza y repara datos entre dispositivos. Usa estas herramientas si los datos no se ven correctamente en diferentes equipos.
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <Button 
                            onClick={() => router.push('/admin/defragment-data')}
                            variant="outline"
                        ...
                        <Button 
                            onClick={() => router.push('/admin/data-diagnostic')}
                            variant="outline"
                            className="w-full border-orange-300 hover:bg-orange-100 dark:hover:bg-orange-900"
                        >
                        ...
                        <Button 
                            onClick={() => router.push('/admin/migrate-users')}
                            variant="outline"
                            className="w-full border-orange-300 hover:bg-orange-100 dark:hover:bg-orange-900"
                        >
                    ...
                    <p className="text-xs text-muted-foreground mt-4">
                        <strong>Defragmentar:</strong> Sube datos locales a Firebase | 
